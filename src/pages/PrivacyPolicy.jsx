    ...
    <section className="bg-[#F2F8F3] py-16">
      <div className="w-11/12 mx-auto max-w-4xl bg-white p-10 rounded-2xl shadow-md border border-[#E5EDE7]">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          At <span className="text-[#38AD2D] font-semibold">GreenNest</span>, we
          value your privacy and are committed to protecting your personal
          information. This Privacy Policy outlines how we collect, use, and
          safeguard your data when you visit our website, purchase products, or
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          We collect different types of information to provide and improve your
          experience:
        </p>
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
          ...
          <li>
            <strong>Account Data:</strong> Profile details if you sign up or log
            in.
          </li>
          <li>
            <strong>Purchase Information:</strong> Order details, delivery
            address (if applicable).
          </li>
          <li>
            <strong>Usage Data:</strong> Pages visited, browsing behavior,
            device information.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 mb-6">
          ...
          <li>
            Send promotions, updates, and eco-friendly tips (only if you
            consent).
          </li>
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          We value your trust. Your information is{" "}
          <strong>never sold or traded</strong>. However, we may share data with
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Your security is important to us. We use modern safeguards such as
          encryption, secure servers, and limited data access to protect your
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          GreenNest uses cookies to enhance your browsing experience — such as
          remembering your preferences, analyzing traffic, and improving
          functionality. You may disable cookies anytime from your browser
          settings.
        </p>
        ...
        <div className="bg-[#F2F8F3] p-5 rounded-xl border border-[#D7E9DB] text-[#1B4332]">
          <p>
            <strong>Email:</strong> privacy@greennest.com
          </p>
          <p>
